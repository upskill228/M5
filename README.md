...
## Link repositório
https://github.com/upskill228/M5.git
...
git clone https://github.com/upskill228/M5.git
...
5. O servidor ficará disponível em:
http://localhost:3000
...
Por fim, foi dada especial atenção à legibilidade e coerência estrutural. Apesar dos enunciados utilizarem dados em português, optou-se pela utilização do inglês em todo o código, seguindo boas práticas de desenvolvimento e promovendo consistência. Assim, alguns campos foram adaptados ("nome" foi substituído por "name", "ativo" por "active").
